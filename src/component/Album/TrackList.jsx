					...
					<div className="bloc" key={index}>
						<Link to={`/track/${tracklist.name}/${tracklist.artist}`}>
							<div className="blocpist">
								<div>
									<img
										className="img-bloc-pist"
										src={tracklist.image[4]["#text"]}
										alt={tracklist.image["#text"]}
									/>
								</div>
									...
									<div className="blocpist-infos-time">
										<div>
											<img
												src={play}
												alt="Logo"
												className="blocpist-infos-logo"
											/>
										</div>
										<div className="track-duration">
											{Math.floor(alb.duration / 60)} m{" "}
											{alb.duration % 60 ? alb.duration % 60 : "00"} s
										</div>
									</div>
								</div>
							</div>
