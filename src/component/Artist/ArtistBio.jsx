			...
			{artistInfo ? (
				<p>
					{artistInfo.bio.summary
						.substring(0, artistInfo.bio.summary.indexOf("<a href") - 1)
						.concat("", "..")}
					<a
						href={`https://${artistInfo.bio.summary
							.substring(
								artistInfo.bio.summary.indexOf("<a href"),
								artistInfo.bio.summary.length
							)
						...
						rel="noreferrer"
					>
						(click here to read more on www.last.fm)
					</a>
				</p>
			) : (
