			...
			{albums ? (
				<div className="artistAlbums">
					<div className="albumsPages">
						{firstAlbum >= numRes ? (
							<p className="albumsPrev" onClick={prevClick}>
								<FontAwesomeIcon icon={faChevronLeft} />
							</p>
						) : (
							<p className="noPrev" onClick={prevClick}>
								<FontAwesomeIcon icon={faChevronLeft} />
							</p>
						)}
					</div>
					{albums.slice(firstAlbum, lastAlbum).map((album, index) => (
						<ArtistAlbumCard key={index} album={album} />
					))}
					<div className="albumsPages">
						{lastAlbum < albums.length && (
							<p className="albumsNext" onClick={nextClick}>
